...
<body>
    ...
    <!--CABECERA-->
    <header>
        <a href="../php/index_log.php" class="logo">
        ...
        <nav class="nav">
            <ul>
                <li><a href="../php/nosotros_log.php">¿Quiénes somos?</a></li>
                <li><a href="../php/blog_log.php"><i class="fa-solid fa-newspaper"></i>Blog</a></li>
                <li><a href="#"><i class="fa-solid fa-paw"></i>Deja tu huella</a>
                    <ul>
                        <li><a href="../php/adopta_log.php">Adopta</a></li>
                        <li><a href="../php/reporta_log.php">Reporta</a></li>
                        <li><a href="../php/donaciones_log.php">Donaciones</a>
                    </ul>
                </li>

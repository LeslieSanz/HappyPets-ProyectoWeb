...
class Usuario {
    ...
    public function actualizarUsuarioConFoto($cod, $nombre, $correo, $dni, $celular, $distrito, $foto) {
    ...
    public function actualizarUsuarioSinFoto($cod, $nombre, $correo, $dni, $celular, $distrito) {
